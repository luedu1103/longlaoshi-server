...
async fn open_ai_create_conversation(state: &State<MyState>) -> Result<Value, Status> {
...
async fn open_ai_chat_with_your_assistant(thread: String, msg: String, state: &State<MyState>) -> Result<Value, Status> {
